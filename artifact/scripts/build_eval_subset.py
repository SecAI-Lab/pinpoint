...
a Colab T4. Costed from the archived full-corpus runs, that is this 32-binary
list at 1.59 h plus 2.38 h; the next size up is 33 binaries at 4.86 h, over the
target. The archive overstates, since its per-binary times were measured with
several workers sharing a machine: the list actually runs in 1 h 21 m plus
1 h 42 m on a Colab T4.
